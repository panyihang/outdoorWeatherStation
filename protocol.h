...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "pelpvy8yyiebjn0b"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//气压(只上报)
//备注:
#define DPID_AIR_PRESSURE 101
//光照强度(只上报)
//备注:
#define DPID_LIGHT_INTENSITY 102
//海拔(只上报)
//备注:
#define DPID_ALTITUDE 103
//是否下雨(只上报)
//备注:
#define DPID_IS_RAIN 104
//是否在充电(只上报)
//备注:
#define DPID_IS_CHARGE 105
//重置(可下发可上报)
//备注:
#define DPID_RSET 106
//temp_0(可下发可上报)
//备注:
#define DPID_TEMP_0 107
